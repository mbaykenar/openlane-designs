...
set ::env(FP_PDN_MACRO_HOOKS) "\
   cpu vccd1 vssd1 vccd1 vssd1, \
   spimemio vccd1 vssd1 vccd1 vssd1, \
   simpleuart vccd1 vssd1 vccd1 vssd1, \
   mem_decode vccd1 vssd1 vccd1 vssd1, \
   memory vccd1 vssd1 vccd1 vssd1"
