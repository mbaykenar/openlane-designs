...
#et ::env(FP_PDN_CORE_RING_VWIDTH) 3.1
#et ::env(FP_PDN_CORE_RING_HWIDTH) 3.1
#et ::env(FP_PDN_CORE_RING_VOFFSET) 12.45
#et ::env(FP_PDN_CORE_RING_HOFFSET) 12.45
#et ::env(FP_PDN_CORE_RING_VSPACING) 1.7
#et ::env(FP_PDN_CORE_RING_HSPACING) 1.7
#et ::env(FP_PDN_VWIDTH) 3.1
#et ::env(FP_PDN_HWIDTH) 3.1
#et ::env(FP_PDN_VSPACING) [expr::(5 * $FP_PDN_CORE_RING_VWIDTH)]
#et ::env(FP_PDN_HSPACING) [expr::(5 * $FP_PDN_CORE_RING_HWIDTH)]
#et ::env(FP_PDN_VPITCH) 180
#et ::env(FP_PDN_HPITCH) 180
#et ::env(FP_PDN_VOFFSET) 5
#et ::env(FP_PDN_HOFFSET) 5
